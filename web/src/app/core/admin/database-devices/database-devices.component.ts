...
@Component({
  selector: 'app-database-devices',
  templateUrl: './database-devices.component.html',
  styleUrls: ['./database-devices.component.scss']
})
export class DatabaseDevicesComponent implements OnInit {
