...
let RegisterPage = class RegisterPage {
    constructor(authService, userService, formBuilder, router, 
    ...
    ngOnInit() {
        this.registerForm = this.formBuilder.group({
            ...
            identification_number: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
    ...
    register() {
        this.isLoading = true;
        this.authService.registerAccount(this.registerForm.value).subscribe((res) => {
            // Success
            this.isLoading = false;
            console.log(res);
            this.userService.update(res.user.pk, this.registerForm.value).subscribe((res) => {
                console.log(res);
            }, (err) => {
                console.error(err);
            });
