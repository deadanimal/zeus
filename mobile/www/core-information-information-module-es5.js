...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-information-information-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCoreInformationInformationPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppExpandableExpandableExpandableComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreInformationInformationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreInformationInformationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _expandable_expandable_expandable_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    InformationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _information_routing_module__WEBPACK_IMPORTED_MODULE_6__["InformationPageRoutingModule"]],
      declarations: [_information_page__WEBPACK_IMPORTED_MODULE_7__["InformationPage"], _expandable_expandable_expandable_component__WEBPACK_IMPORTED_MODULE_1__["ExpandableComponent"]]
  ...
  /***/
  function srcAppCoreInformationInformationPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreInformationInformationPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var InformationPage = /*#__PURE__*/function () {
      function InformationPage() {
        ...
        this.items = [{
          expanded: false,
          title: 'Protect small children from hazard',
          message: "Toddlers and small children are very curious- and they love to explore just about everything. Parents of small children " + "should put tamper-resistant safety caps on all unused electrical outlets. In addition, all loose cards should be tidied up and put " + "out of reach to avoid kids tugging on them."
        }, {
          expanded: false,
          title: 'Avoid extension cord as much as possible',
          message: "Running extension cords through the house can trip up residents; this can cause injury and damage to the wire or outlet " + "if it causes the cord to be ripped out of the wall. If you find yourself using extension cords very often, consider having an " + "electrican install new outlets throughout your home."
        }, {
          expanded: false,
          title: 'Keep electrical equipment or outlet away from water',
          message: "Water conducts electricity, so even the slightest exposure to this dangerous mix can lead to injury. Make sure you wipe " + "up any spills to ensure that plugs don\'t get well."
        }, {
          expanded: false,
          title: 'Don\'t overload your outlets',
          message: "Every outlet in your home is designed to deliver a certain amount of electricity; by plugging too many devices into it at " + "once, you could cause a small explosion or a fire. If you have a lot of things to plug in, use a power strip (an energy saving " + "one of course!)that can safely accommodate your needs. "
        }, {
          expanded: false,
          title: 'Replace and repair the damage power cords',
          message: "Exposed wiring is a danger that cannot go overlooked, the NFPA wrote. If you see the protective coating on a wire is stripped " + "away, be sure to replace it or cover it with electrical tape as soon as possible."
        }];
      }
    ...
    InformationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/core/information/information.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./information.page.scss */
      "./src/app/core/information/information.page.scss"))["default"]]
    })], InformationPage);
    /***/
  },
  ...
  /***/
  function srcAppExpandableExpandableExpandableComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppExpandableExpandableExpandableComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ExpandableComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/expandable/expandable/expandable.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./expandable.component.scss */
      "./src/app/expandable/expandable/expandable.component.scss"))["default"]]
    })], ExpandableComponent);
    /***/
  }
}]);
//# sourceMappingURL=core-information-information-module-es5.js.map