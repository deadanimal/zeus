...
let AppliancesService = class AppliancesService {
    ...
    update(body) {
        return this.http.patch(this.urlAppliances, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            console.log('Appliance: ', res);
        }));
    }
    delete(id) {
...
let UsersService = class UsersService {
    constructor(http) {
        this.http = http;
        // URL
        this.urlUsers = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + 'v1/users/';
        // Data
        this.users = [];
    }
    post(body) {
        return this.http.post(this.urlUsers, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            console.log('User: ', res);
        }));
    }
    get() {
        return this.http.get(this.urlUsers).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
    ...
    update(id, body) {
        return this.http.put(this.urlUsers, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            this.user = res;
            console.log('User: ', res);
        }));
    }
    delete(id) {
        return this.http.delete(this.urlUsers + id + '/').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            console.log('User: ', res);
        }));
    }
};
