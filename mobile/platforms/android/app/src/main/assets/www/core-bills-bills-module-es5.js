    ...
    var BillsService = /*#__PURE__*/function () {
      ...
      _createClass(BillsService, [{
        ...
        value: function filter(field) {
          ...
          var urlTemp = this.urlBills + '?' + field;
          return this.http.get(urlTemp).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
            _this4.billsFiltered = res;
            console.log('Bills filtered: ', _this4.billsFiltered);
          }));
        }
      }]);
