...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-profile-profile-module"], {
  ...
  function srcAppCoreProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_activities_activities_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/shared/services/activities/activities.service */
    "./src/app/shared/services/activities/activities.service.ts");

    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(activityService, fb) {
      ...
      _createClass(ProfilePage, [{
        ...
        key: "create",
        value: function create(type, state) {
          ...
          this.activityService.post(this.activityForm.value).subscribe(function () {});
        }
      }]);
  ...
  /***/
  function srcAppSharedServicesActivitiesActivitiesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ActivitiesService = /*#__PURE__*/function () {
      function ActivitiesService(http) {
        ...
        this.urlActivity = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + 'v1/appliance-activities/'; // Data
      ...
      _createClass(ActivitiesService, [{
        ...
        value: function post(body) {
          return this.http.post(this.urlActivity, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
